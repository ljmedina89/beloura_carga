...
- `admin.html` incluye un modulo de recepcion rapida para paquetes que llegan a bodega NY, por ejemplo Amazon para Mayra. Ese flujo registra piezas en `PAQUETES_BODEGA` con codigo `PKG...`; el codigo de envio `NY...` se asigna despues al armar o consolidar.
